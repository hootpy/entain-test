...
const file_sports_sports_proto_rawDesc = "" +
	...
	"\x06events\x18\x01 \x03(\v2\r.sports.EventR\x06events\"\x91\x01\n" +
	"\x17ListEventsRequestFilter\x12\x1d\n" +
	"\avisible\x18\x01 \x01(\bH\x00R\avisible\x88\x01\x01\x12\x19\n" +
	"\x05order\x18\x02 \x01(\tH\x01R\x05order\x88\x01\x01\x12\x1b\n" +
	...
	"\x15advertised_start_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\x13advertisedStartTime\x12\x18\n" +
	"\avisible\x18\x04 \x01(\bR\avisible\x12\x16\n" +
	"\x06status\x18\a \x01(\tR\x06status2i\n" +
	"\x06Sports\x12_\n" +
	"\n" +
